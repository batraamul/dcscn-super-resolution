...
def get_split_images(image, window_size, stride=None, enable_duplicate=False):
    print("--------------Dear Friends i am inside the get_split_images function of UTILITIES")
    ...
    print("PRINTING THE WINDOWS")
    print(windows.shape[0],windows.shape[1],windows.shape[2],windows.shape[3],windows.shape)
